...
onoremap <F4>  <ESC>:<NERDTreeToggle<CR>

nnoremap <F5>       :SyntasticCheck<CR>
onoremap <C-F5><ESC>:SyntasticCheck<CR>

nnoremap <F6>       :Dispatch<CR>
inoremap <F6>       :Dispatch<CR>

nnoremap <leader>qr :Neomake<CR>
vnoremap <leader>qr :Neomake<CR>
